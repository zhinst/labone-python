...
from labone.resources import (
    reflection_capnp,  # type: ignore[attr-defined, import-untyped]
)
...
class ReflectionServer:
    ...
    def __del__(self) -> None:
        ...
        _ = asyncio.ensure_future(self._close_rpc_client(), loop=self._creation_loop)
